...
public class HexCoordinateTest {
    ...
    public void testGetRing1() {
        ...
        Assert.assertEquals(new HexCoordinate(1, 0), actual[0]);
        Assert.assertEquals(new HexCoordinate(1, -1), actual[1]);
        Assert.assertEquals(new HexCoordinate(0, -1), actual[2]);
        Assert.assertEquals(new HexCoordinate(-1, 0), actual[3]);
        Assert.assertEquals(new HexCoordinate(-1, 1), actual[4]);
        Assert.assertEquals(new HexCoordinate(0, 1), actual[5]);
    }
    ...
    public void testGetRing3() {
        ...
        Assert.assertEquals(new HexCoordinate(3, 0), actual[0]);
        Assert.assertEquals(new HexCoordinate(3, -3), actual[3]);
        Assert.assertEquals(new HexCoordinate(0, -3), actual[6]);
        Assert.assertEquals(new HexCoordinate(-3, 0), actual[9]);
        Assert.assertEquals(new HexCoordinate(-3, 3), actual[12]);
        Assert.assertEquals(new HexCoordinate(0, 3), actual[15]);
    }    
}